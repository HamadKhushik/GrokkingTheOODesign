...
public class Board {
	...
	public void resetBoard() {
		...
		boxes[0][0] = new Box(new Rook(false), 7, 0);
		boxes[0][1] = new Box(new Knight(false), 7, 1);
		boxes[0][2] = new Box(new Bishop(false), 7, 2);
		// ..
		boxes[1][0] = new Box(new Pawn(false), 6, 0);
		boxes[1][1] = new Box(new Pawn(false), 6, 1);
		// ..
